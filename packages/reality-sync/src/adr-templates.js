...
function getTemplateNames() {
    return Object.keys(exports.ADR_TEMPLATES);
}
function getTemplate(name) {
    return exports.ADR_TEMPLATES[name];
}
function renderTemplate(templateName, variables) {
    const template = exports.ADR_TEMPLATES[templateName];
    if (!template)
...
//# sourceMappingURL=adr-templates.js.map