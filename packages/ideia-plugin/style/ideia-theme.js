...
exports.ideiaColors = exports.IDEIA_DARK_THEME = void 0;
exports.registerIdeiaTheme = registerIdeiaTheme;
exports.registerIdeiaColors = registerIdeiaColors;
const theming_1 = require("@theia/core/lib/browser/theming");
exports.IDEIA_DARK_THEME = {
    id: 'ideia-dark',
    label: 'IDEIA Dark',
    type: 'dark',
...
function registerIdeiaTheme() {
    theming_1.ThemeService.get().register(exports.IDEIA_DARK_THEME);
}
function registerIdeiaColors(registry) {
    registry.register(...exports.ideiaColors);
}
//# sourceMappingURL=ideia-theme.js.map