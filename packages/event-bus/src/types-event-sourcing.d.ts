...
export declare class ConcurrencyError extends Error {
    ...
    constructor(message: string, expectedVersion: number, actualVersion: number, aggregateType: string, aggregateId: string);
}
//# sourceMappingURL=types-event-sourcing.d.ts.map