...
exports.VisualSchema = void 0;
exports.createVisualSchema = createVisualSchema;
const DEFAULT_VISUAL_FIELDS = [
...
class VisualSchema {
    ...
    getFieldWidget(field) {
        ...
        if (field.required)
            widget.validationMessage = `${field.label} is required`;
        return widget;
    }
    getFieldGroups() {
    ...
    generateUISchema() {
        ...
        for (const [key, field] of this.fields) {
            ...
            if (field.type === 'slider') {
                if (field.min !== undefined)
                    entry['ui:options'] = { min: field.min, max: field.max, step: field.step ?? 1 };
            }
            uiSchema[key] = entry;
        }
        return uiSchema;
...
exports.VisualSchema = VisualSchema;
function createVisualSchema() {
    return new VisualSchema();
}
//# sourceMappingURL=visual-schema.js.map