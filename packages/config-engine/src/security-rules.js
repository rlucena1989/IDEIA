...
const logger = (0, logger_1.createLogger)('security-rules');
function getValue(config, dottedPath) {
...
function getValueMulti(config, ...paths) {
...
function isHighAutonomy(autonomy) {
