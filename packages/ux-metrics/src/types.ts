...
export interface CesReport {
  totalResponses: number;
  avgScore: number;
  byTaskType: Record<string, { count: number; avgScore: number; avgDurationMs: number }>;
...
export interface TimeToTaskReport {
  ...
  byTaskType: Record<string, { count: number; avgDurationMs: number }>;
}
...
export interface AccessibilityReport {
  ...
  minScore: number;
  maxScore: number;
  bySource: Record<string, { count: number; avgScore: number; totalViolations: number }>;
