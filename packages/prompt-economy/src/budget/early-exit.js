...
exports.EarlyExitDecider = void 0;
...
class EarlyExitDecider {
    config;
    constructor(config = {}) {
        this.config = { ...DEFAULT_CONFIG, ...config };
    }
    shouldExit(taskType, evidence) {
...
exports.EarlyExitDecider = EarlyExitDecider;
//# sourceMappingURL=early-exit.js.map