...
export function diffText(original: string, modified: string, filePath: string): TextDiff {
...
export function diffTexts(files: { path: string; original: string; modified: string }[]): {
  diffs: TextDiff[];
  totalFiles: number;
  totalAdded: number;
  totalRemoved: number;
