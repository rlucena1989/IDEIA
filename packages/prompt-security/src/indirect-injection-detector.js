...
exports.IndirectInjectionDetector = void 0;
exports.createIndirectInjectionDetector = createIndirectInjectionDetector;
const logger_1 = require("@ideia/logger");
const log = (0, logger_1.createLogger)('indirect-injection-detector');
...
class IndirectInjectionDetector {
    ...
    calculateConfidence(severity, matchLength) {
        const severityBase = {
            low: 0.3,
            medium: 0.5,
            high: 0.7,
...
exports.IndirectInjectionDetector = IndirectInjectionDetector;
function createIndirectInjectionDetector() {
    return new IndirectInjectionDetector();
}
//# sourceMappingURL=indirect-injection-detector.js.map