...
exports.BiasDetector = void 0;
exports.createBiasDetector = createBiasDetector;
        ...
        for (const category of this.categories) {
            for (const pattern of category.patterns) {
                ...
                if (match) {
                    ...
                    if (sensIdx > maxSensitivity)
                        maxSensitivity = sensIdx;
                }
            }
        }
        return {
            ...
            overallSensitivity: matches.length > 0 ? sensitivityOrder[maxSensitivity] : 'none',
...
exports.BiasDetector = BiasDetector;
function createBiasDetector() {
